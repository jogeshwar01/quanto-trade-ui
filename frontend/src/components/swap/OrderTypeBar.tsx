...
const OrderTypeBar: React.FC<OrderTypeBarProps> = ({
  ...
  return (
    <div className="inline-flex h-[38px] w-full justify-center text-muted-foreground border-b border-border">
      ...
      <button
        type="button"
        className={`inline-flex flex-1 cursor-pointer items-center justify-center whitespace-nowrap px-4 py-2  text-lg font-medium transition-all focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-b border-border ${
